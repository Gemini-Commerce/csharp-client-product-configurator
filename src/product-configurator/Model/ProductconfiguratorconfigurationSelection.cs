...
namespace product-configurator.Model
{
    ...
    /// </summary>
    [DataContract(Name = "productconfiguratorconfigurationSelection")]
    public partial class ProductconfiguratorconfigurationSelection : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductconfiguratorconfigurationSelection" /> class.
        /// </summary>
        /// <param name="stepId">stepId.</param>
        /// <param name="optionIds">optionIds.</param>
        public ProductconfiguratorconfigurationSelection(string stepId = default(string), List<string> optionIds = default(List<string>))
        {
            this.StepId = stepId;
