...
namespace product-configurator.Model
{
    ...
    /// </summary>
    [DataContract(Name = "productconfiguratormatrixEntity")]
    public partial class ProductconfiguratormatrixEntity : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductconfiguratormatrixEntity" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="grn">grn.</param>
        /// <param name="configuratorId">configuratorId.</param>
        /// <param name="label">label.</param>
        /// <param name="defaultPropertyId">defaultPropertyId.</param>
        ...
        public ProductconfiguratormatrixEntity(string id = default(string), string grn = default(string), string configuratorId = default(string), string label = default(string), string defaultPropertyId = default(string), ProductconfiguratorPropertyMode? propertiesMode = default(ProductconfiguratorPropertyMode?), MatrixGenericType genericType = default(MatrixGenericType), MatrixPriceType priceType = default(MatrixPriceType), MatrixWeightType weightType = default(MatrixWeightType), List<ProductconfiguratormatrixStep> steps = default(List<ProductconfiguratormatrixStep>), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
            this.Grn = grn;
        ...
        /// <summary>
        /// Gets or Sets DefaultPropertyId
        /// </summary>
