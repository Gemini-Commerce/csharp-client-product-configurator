...
namespace product-configurator.Model
{
    ...
    /// </summary>
    [DataContract(Name = "productconfiguratoroptionEntity")]
    public partial class ProductconfiguratoroptionEntity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductconfiguratoroptionEntity" /> class.
        /// </summary>
        ...
        public ProductconfiguratoroptionEntity(string id = default(string), string grn = default(string), LocalisationLocalizedText label = default(LocalisationLocalizedText), string position = default(string), OptionSwatch swatch = default(OptionSwatch), string externalReferenceId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
            this.Grn = grn;
            this.Label = label;
