...
namespace product-configurator.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductConfigurator_CreateOption_request")]
    public partial class ProductConfiguratorCreateOptionRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductConfiguratorCreateOptionRequest" /> class.
        /// </summary>
        /// <param name="label">label.</param>
        /// <param name="position">position.</param>
        /// <param name="externalReferenceId">externalReferenceId.</param>
        /// <param name="swatch">swatch.</param>
        public ProductConfiguratorCreateOptionRequest(LocalisationLocalizedText label = default(LocalisationLocalizedText), string position = default(string), string externalReferenceId = default(string), OptionSwatch swatch = default(OptionSwatch))
        {
            this.Label = label;
