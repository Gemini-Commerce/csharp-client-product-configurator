...
namespace productconfigurator.Api
{
    ...
    public interface IProductConfiguratorApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ProductconfiguratorpropertyEntity> ProductConfiguratorGetPropertyAsync(string tenantId, string propertyId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ProductconfiguratorpropertyEntity>> ProductConfiguratorGetPropertyWithHttpInfoAsync(string tenantId, string propertyId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class ProductConfiguratorApi : IProductConfiguratorApi
    {
        ...
        /// <returns></returns>
        public ProductConfiguratorApi(productconfigurator.Client.Configuration configuration)
        {
        ...
        public ProductConfiguratorApi(productconfigurator.Client.ISynchronousClient client, productconfigurator.Client.IAsynchronousClient asyncClient, productconfigurator.Client.IReadableConfiguration configuration)
        {
        ...
        {
            productconfigurator.Client.ApiResponse<ProductconfiguratorpropertyEntity> localVarResponse = ProductConfiguratorGetPropertyWithHttpInfo(tenantId, propertyId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProductconfiguratorpropertyEntity</returns>
        public productconfigurator.Client.ApiResponse<ProductconfiguratorpropertyEntity> ProductConfiguratorGetPropertyWithHttpInfo(string tenantId, string propertyId, int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new productconfigurator.Client.ApiException(400, "Missing required parameter 'tenantId' when calling ProductConfiguratorApi->ProductConfiguratorGetProperty");
            }

            // verify the required parameter 'propertyId' is set
            if (propertyId == null)
            {
                throw new productconfigurator.Client.ApiException(400, "Missing required parameter 'propertyId' when calling ProductConfiguratorApi->ProductConfiguratorGetProperty");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProductconfiguratorpropertyEntity</returns>
        public async System.Threading.Tasks.Task<ProductconfiguratorpropertyEntity> ProductConfiguratorGetPropertyAsync(string tenantId, string propertyId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            productconfigurator.Client.ApiResponse<ProductconfiguratorpropertyEntity> localVarResponse = await ProductConfiguratorGetPropertyWithHttpInfoAsync(tenantId, propertyId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProductconfiguratorpropertyEntity)</returns>
        public async System.Threading.Tasks.Task<productconfigurator.Client.ApiResponse<ProductconfiguratorpropertyEntity>> ProductConfiguratorGetPropertyWithHttpInfoAsync(string tenantId, string propertyId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
        ...
        {
            productconfigurator.Client.ApiResponse<PropertyListPropertiesByConfigurationResponse> localVarResponse = ProductConfiguratorListPropertiesByConfigurationWithHttpInfo(tenantId, configuratorId, pageSize, body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PropertyListPropertiesByConfigurationResponse</returns>
        public productconfigurator.Client.ApiResponse<PropertyListPropertiesByConfigurationResponse> ProductConfiguratorListPropertiesByConfigurationWithHttpInfo(string tenantId, string configuratorId, string pageSize, ProductConfiguratorListPropertiesByConfigurationRequest body, int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new productconfigurator.Client.ApiException(400, "Missing required parameter 'tenantId' when calling ProductConfiguratorApi->ProductConfiguratorListPropertiesByConfiguration");
            }

            // verify the required parameter 'configuratorId' is set
            if (configuratorId == null)
            {
                throw new productconfigurator.Client.ApiException(400, "Missing required parameter 'configuratorId' when calling ProductConfiguratorApi->ProductConfiguratorListPropertiesByConfiguration");
            }

            // verify the required parameter 'pageSize' is set
            if (pageSize == null)
            {
                throw new productconfigurator.Client.ApiException(400, "Missing required parameter 'pageSize' when calling ProductConfiguratorApi->ProductConfiguratorListPropertiesByConfiguration");
            }

            // verify the required parameter 'body' is set
            if (body == null)
            {
                throw new productconfigurator.Client.ApiException(400, "Missing required parameter 'body' when calling ProductConfiguratorApi->ProductConfiguratorListPropertiesByConfiguration");
            }
        ...
        {
            productconfigurator.Client.ApiResponse<PropertyListPropertiesByConfigurationResponse> localVarResponse = await ProductConfiguratorListPropertiesByConfigurationWithHttpInfoAsync(tenantId, configuratorId, pageSize, body, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PropertyListPropertiesByConfigurationResponse)</returns>
        public async System.Threading.Tasks.Task<productconfigurator.Client.ApiResponse<PropertyListPropertiesByConfigurationResponse>> ProductConfiguratorListPropertiesByConfigurationWithHttpInfoAsync(string tenantId, string configuratorId, string pageSize, ProductConfiguratorListPropertiesByConfigurationRequest body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
