...
namespace productconfigurator.Model
{
    ...
    /// </summary>
    [DataContract(Name = "productconfiguratorconfigurationOption")]
    public partial class ProductconfiguratorconfigurationOption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductconfiguratorconfigurationOption" /> class.
        /// </summary>
        ...
        public ProductconfiguratorconfigurationOption(string id = default(string), string grn = default(string), LocalisationLocalizedText label = default(LocalisationLocalizedText), string position = default(string), OptionSwatch swatch = default(OptionSwatch), bool enabled = default(bool), List<ConfigurationOptionProperty> optionProperties = default(List<ConfigurationOptionProperty>), bool hasQuantity = default(bool))
        {
            this.Id = id;
            this.Grn = grn;
            this.Label = label;
