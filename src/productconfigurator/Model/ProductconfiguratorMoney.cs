...
namespace productconfigurator.Model
{
    ...
    /// </summary>
    [DataContract(Name = "productconfiguratorMoney")]
    public partial class ProductconfiguratorMoney : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductconfiguratorMoney" /> class.
        /// </summary>
        ...
        public ProductconfiguratorMoney(string units = default(string), int micros = default(int))
        {
            this.Units = units;
            this.Micros = micros;
