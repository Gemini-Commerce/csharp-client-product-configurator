...
namespace productconfigurator.Model
{
    ...
    /// </summary>
    [DataContract(Name = "productconfiguratorpropertyGenericProperty")]
    public partial class ProductconfiguratorpropertyGenericProperty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductconfiguratorpropertyGenericProperty" /> class.
        /// </summary>
        /// <param name="propertyKey">propertyKey.</param>
        /// <param name="propertyValue">propertyValue.</param>
        public ProductconfiguratorpropertyGenericProperty(string propertyKey = default(string), string propertyValue = default(string))
        {
