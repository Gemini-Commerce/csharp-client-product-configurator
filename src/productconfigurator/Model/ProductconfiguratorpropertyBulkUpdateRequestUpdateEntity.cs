...
namespace productconfigurator.Model
{
    ...
    /// </summary>
    [DataContract(Name = "productconfiguratorpropertyBulkUpdateRequestUpdateEntity")]
    public partial class ProductconfiguratorpropertyBulkUpdateRequestUpdateEntity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductconfiguratorpropertyBulkUpdateRequestUpdateEntity" /> class.
        /// </summary>
        /// <param name="propertyId">propertyId.</param>
        /// <param name="payload">payload.</param>
        /// <param name="payloadMask">payloadMask.</param>
        public ProductconfiguratorpropertyBulkUpdateRequestUpdateEntity(string propertyId = default(string), ProductconfiguratorpropertyUpdatePayload payload = default(ProductconfiguratorpropertyUpdatePayload), string payloadMask = default(string))
        {
