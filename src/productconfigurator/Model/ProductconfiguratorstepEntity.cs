...
namespace productconfigurator.Model
{
    ...
    /// </summary>
    [DataContract(Name = "productconfiguratorstepEntity")]
    public partial class ProductconfiguratorstepEntity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductconfiguratorstepEntity" /> class.
        /// </summary>
        ...
        public ProductconfiguratorstepEntity(string id = default(string), string grn = default(string), LocalisationLocalizedText label = default(LocalisationLocalizedText), LocalisationLocalizedText description = default(LocalisationLocalizedText), string subjectToStepId = default(string), string position = default(string), bool isRequired = default(bool), List<ProductconfiguratoroptionEntity> options = default(List<ProductconfiguratoroptionEntity>), bool hasMultipleSelection = default(bool), bool optionsHaveQuantity = default(bool), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
            this.Grn = grn;
            this.Label = label;
        ...
        public List<ProductconfiguratoroptionEntity> Options { get; set; }
