...
namespace productconfigurator.Model
{
    ...
    public partial class ConfigurationProperty : IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets PropertyMode
        /// </summary>
        [DataMember(Name = "propertyMode", EmitDefaultValue = false)]
        public ProductconfiguratorPropertyMode? PropertyMode { get; set; }
        /// <summary>
        ...
        public ConfigurationProperty(string id = default(string), string grn = default(string), List<string> optionIds = default(List<string>), string propertyKey = default(string), string propertyValue = default(string), ProductconfiguratorPropertyType? propertyType = default(ProductconfiguratorPropertyType?), ProductconfiguratorPropertyMode? propertyMode = default(ProductconfiguratorPropertyMode?))
        {
            this.Id = id;
            this.Grn = grn;
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PropertyMode: ").Append(PropertyMode).Append("\n");
