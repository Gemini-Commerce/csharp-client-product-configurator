...
namespace productconfigurator.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductConfigurator_CreateMatrix_request")]
    public partial class ProductConfiguratorCreateMatrixRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductConfiguratorCreateMatrixRequest" /> class.
        /// </summary>
        ...
        public ProductConfiguratorCreateMatrixRequest(string configuratorId = default(string), string label = default(string), MatrixGenericType genericType = default(MatrixGenericType), MatrixPriceType priceType = default(MatrixPriceType), MatrixWeightType weightType = default(MatrixWeightType), List<ProductconfiguratormatrixStep> steps = default(List<ProductconfiguratormatrixStep>), ProductconfiguratorPropertyMode? propertiesMode = default(ProductconfiguratorPropertyMode?))
        {
