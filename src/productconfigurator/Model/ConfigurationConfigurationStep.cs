...
namespace productconfigurator.Model
{
    ...
    /// </summary>
    [DataContract(Name = "configurationConfigurationStep")]
    public partial class ConfigurationConfigurationStep : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationConfigurationStep" /> class.
        /// </summary>
        ...
        public ConfigurationConfigurationStep(string id = default(string), string grn = default(string), LocalisationLocalizedText label = default(LocalisationLocalizedText), List<ConfigurationStepOption> options = default(List<ConfigurationStepOption>), bool hasMultipleSelection = default(bool))
        {
            this.Id = id;
            this.Grn = grn;
            this.Label = label;
        ...
        public List<ConfigurationStepOption> Options { get; set; }
